...
log_in_button = driver.find_element(
    By.XPATH, '//*[@id="o-1556761323"]/div/div[1]/div/main/div[1]/div/div/div/div/header/div/div[2]/div[2]/a')
log_in_button.click()
time.sleep(2)
fb_sign_in_button = driver.find_element(
    By.XPATH, '//*[@id="o-1335420887"]/div/div/div[1]/div/div[3]/span/div[2]/button')
...
location_button = driver.find_element(
    By.XPATH, '//*[@id="o-1335420887"]/div/div/div/div/div[3]/button[1]')
...
time.sleep(2)
decline_button = driver.find_element(
    By.XPATH, '//*[@id="o-1556761323"]/div/div[1]/div/div/main/div/div[1]/div[1]/div/div[4]/div/div[2]/button')
for n in range(100):
    try:
        time.sleep(2)
