...
def add_cafe():
    ...
    if form.validate_on_submit():
        path = 'C:/Users/kevin/Projects/StudyFolder/Udemy/Python/day62 - coffee&wifi/cafe-data.csv'
...
@app.route('/cafes')
def cafes():
    with open('C:/Users/kevin/Projects/StudyFolder/Udemy/Python/day62 - coffee&wifi/cafe-data.csv', newline='',encoding='utf-8') as csv_file:
